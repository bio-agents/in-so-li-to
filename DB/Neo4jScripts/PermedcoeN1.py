...
agentsList = ["seurat", "tiedie", "yalla", "boolnet", "cellmodeller", "chemchain", "fastcore", "mongoose",
...
MetaCitationsReduction_filtered = filter_dataframe(MetaCitationsReduction, agentsList, True, None)
