...
def main():
    ...
    create_agents_nodes(driver, dict_config)
    citations_edges(driver, dict_config["metaoccur_edges"])
    add_clusters_pageRank_Database(driver, dict_config["agent_nodes"])
    CreateAgentsTopicsList(driver)
